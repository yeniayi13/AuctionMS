        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuctionFechaInicio = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AuctionFechaFin = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AuctionCondiciones = table.Column<string>(type: "text", nullable: false),
                    AuctionCantidadProducto = table.Column<int>(type: "integer", nullable: false),
